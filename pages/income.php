    ...
    <div class="col-md-12 offset-md-3 col-lg-8 offset-lg-2" id="box">
        <div class="card">
            <div class="col text-center mt-3">
                <h5><i class="fas fa-hand-holding-usd"></i> รายรับ </h5>
            ...
            <form id="form" method="POST">
                ...
                <div class="col-md-12">
                    ...
                    <select id="inoutcome" name="inoutcome" class="selectpicker show-tick mb-3" data-size="8" data-live-search="true" title="เลือกรายการ" data-width="100%" required>
                        <?php
                        $sql = "SELECT * FROM tb_inoutcome_group WHERE inoutcome_group_type ='i'";
                ...
                <div class="col-md-12 mt-2 mb-3" id="form-amount">
                    ...
                    <div class="input-group">
                        <input type="number" value="<?php echo $amount ?>" class="form-control" id="amount" onKeyPress="if(this.value.length==7) return false;" name="amount" placeholder="ตัวอย่าง (100 บาท)" maxlength="10" size="10" required>
                        <div class="input-group-prepend">
                ...
                <div class="col-md-12 text-center mt-4 mb-2">
                    <?php $inoutcome_id ? $btn = 'อัพเดตข้อมูล' : $btn = 'เพิ่มรายรับ' ?>

...
$sql = "SELECT  * FROM tb_plants_step ps LEFT JOIN tb_plants_group pg ON pg.plantgroup_id = ps.plants_step_id ORDER BY plants_step_id";
...
if ($result->num_rows > 0) {
  while ($row = mysqli_fetch_array($result)) {
    ...
    $row['img'] ?
      $img =  '<img  src="' . $pathImg . '/' . $row['img'] . '" alt="Responsive image" class="img-thumbnail mx-auto d-block" 
            ...
            overflow: hidden;         
            "> ' :
      $img = '<img  src="../../images/plants/default.jpg"   loading="lazy"  alt="Responsive image" class="img-thumbnail mx-auto d-block" 
            style="
            height: auto;
            width: 100%;
            overflow: hidden;                  
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
     <h4><span class="badge badge-success">' . $row['name'] . '</span></h4>
